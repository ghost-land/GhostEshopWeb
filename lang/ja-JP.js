export default {
    home: {
      title_1: 'Ghost eShopとは？',
        paragraphe_1:
          'Ghost eShopは、Nintendo 3DSのゲームを集めたデータベースです。GhosteShopがあれば、あなたの3DSは時代遅れにはなりません。このサイトや3DS用Ghost eShopアプリから、ゲームをダウンロードすることができます。',
      title_2: 'Ghost eShopを3DS(New3DS)にインストールするための条件は何ですか？',
        paragraphe_2:
          ...
          paragraphe_2_3:
            '- 以下でダウンロード可能なGhost eShopの最新バージョン',
      title_3:
        'Ghost eShopに無いゲームはどうすればいいですか？',
        paragraphe_3:
          'Ghost eShopに無いゲームは、以下のフォームからリクエストできます。',
      title_4:
        '3DSのGhost eShopアプリを使わずにゲームをダウンロードすることは可能ですか？',
        paragraphe_4:
          '3DSのGhost eShopアプリを使わずにゲームをダウンロードするには、ゲームのQRコードを読み取る（FBI経由でインストールする場合）ことができますが、この公式ウェブサイトからダウンロードすることもできます。',
      faq:'よくある質問:',
    },
    games: {
      search: '検索',
