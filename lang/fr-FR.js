export default {
  home: {
    title_1: "C'est quoi Ghost eShop ?",
      paragraphe_1:
    ...
    title_4:
      ...
      paragraphe_4:
        "Afin de télécharger des jeux sans l'application 3ds, vous pouvez scanner les QR codes des jeux (pour une instalation via FBI), mais vous pouvez aussi directement les télécharger depuis notre site.",
